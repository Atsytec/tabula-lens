...
:::note[Scope]
This guide covers connecting Tabula Lens to the Supabase PostgreSQL database. To protect your Tabula Lens endpoint using Supabase user sessions and JWTs, see the [Supabase Auth Integration](./supabase-auth) guide.
:::
...
Tabula Lens auto-detects `postgresql://` URLs and selects the PostgreSQL/Knex driver.

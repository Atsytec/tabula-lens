...
:::tip[Quick Reference]
For installation and basic usage examples, check out the [@tabula-lens/node README](https://github.com/Atsytec/tabula-lens/blob/main/packages/node/README.md).
:::
...
**Peer Dependencies:**
<PackageManagers pkg="express@^4.18.0 || ^5.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="fastify@^4.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="koa@^2.14.0" />
<PackageManagers pkg="@koa/router" />
...
**Peer Dependencies:**
<PackageManagers pkg="@hapi/hapi@^21.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="restify@^11.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="next@latest" />
...
**Peer Dependencies:**
<PackageManagers pkg="@tanstack/react-start@^1.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="remix@^2.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="@sveltejs/kit@^2.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="hono@^4.0.0" />
...
**Peer Dependencies:**
<PackageManagers pkg="elysia@^1.0.0" />

...
> ⚠️ **Important**: When using Supabase, ensure you have enabled Row Level Security (RLS) policies or use a service role key with appropriate permissions. See the [Supabase integration guide](/user-guides/integrations/supabase) for more details.

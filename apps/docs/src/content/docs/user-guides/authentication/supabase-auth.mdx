...
<PackageManagers pkg="@supabase/supabase-js @supabase/ssr" comment="# Next.js (App Router — uses @supabase/ssr for server-side session handling)" />
<PackageManagers pkg="@supabase/supabase-js" comment="# Express" />

...
:::tip[Quick Reference]
For installation and basic usage examples, check out the [@tabula-lens/react README](https://github.com/Atsytec/tabula-lens/blob/main/packages/react/README.md).
:::

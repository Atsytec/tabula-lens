...
For advanced testing strategies including performance testing, security testing, and visual regression testing, see the [Advanced Testing Guide](./testing-advanced).

## Related Documentation

- [Advanced Testing](/user-guides/production/testing-advanced) - Performance, security, and visual regression testing

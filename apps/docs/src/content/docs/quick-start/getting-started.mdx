...
> **Note:** Tabula Lens supports Express, Fastify, Koa, Hapi, Restify, Hono, Elysia, Next.js, Remix, SvelteKit, TanStack Start, and Fresh. See the [Backend Architecture](/concepts/backend-architecture/) page for the full list.
...
See the [Frontend Implementation](/guides/frontend-implementation/) guide for more customization options.
...
If you're using a framework not shown in the examples, check the [Backend Architecture](/concepts/backend-architecture/) and [Frontend Architecture](/concepts/frontend-architecture/) pages for framework-specific guidance.

## Next Steps

Now that you've integrated Tabula Lens into your application:

- Learn about [Frontend Implementation](/guides/frontend-implementation/) for advanced patterns and customization
- Explore [Backend Implementation](/guides/backend-implementation/) for framework-specific configurations
- Understand the [Architecture](/concepts/architecture/) to learn about the HTTP API contract and interchangeability
- Read about the [Design System](/concepts/design-system/) for styling and theming options
- Check the [Backend Architecture](/concepts/backend-architecture/) for the full list of supported frameworks

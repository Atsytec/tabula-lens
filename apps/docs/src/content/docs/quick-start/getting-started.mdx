...
> 💡 **Quick Reference**: For installation and basic usage examples, check out the package READMEs:
...
> **Note:** Tabula Lens auto-detects your database type from the connection string, so you only need to install the driver for your specific database.
...
> **Note:** Tabula Lens supports Express, Fastify, Koa, Hapi, Restify, Hono, Elysia, Next.js, Remix, SvelteKit, TanStack Start, and Fresh. See the [Backend Architecture](/contributor-docs/architecture/backend-architecture/) page for the full list.

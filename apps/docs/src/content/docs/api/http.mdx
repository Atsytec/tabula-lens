...
> - [React API](/api/react) - Frontend component that consumes this API
> - [Node API](/api/node) - Backend implementation that provides this API
> - [Authentication Guide](/user-guides/integrations/authentication) - How to secure this API
> - [Backend Implementation](/user-guides/backend/backend-implementation) - How to implement this API in your backend

...
:::tip[Quick Reference]
For a quick start guide and basic usage examples, check out the [@tabula-lens/react README](https://github.com/Atsytec/tabula-lens/blob/main/packages/react/README.md).
:::

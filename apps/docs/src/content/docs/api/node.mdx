...
app.get('/api/tabula-lens', expressAdapter(tabulaLens));
...
app.get('/api/tabula-lens', express4Adapter(tabulaLens));
...
fastify.get('/api/tabula-lens', fastifyAdapter(tabulaLens));
...
export const GET = createNextRouteHandler(tabulaLens);
```
...
app.get('/api/tabula-lens', createHonoMiddleware(tabulaLens));
...
app.get('/api/tabula-lens', createElysiaHandler(tabulaLens));
